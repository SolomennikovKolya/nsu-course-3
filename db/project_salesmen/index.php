<!-- Это самая начальная страница для авторизации -->
...
<body>
    <!-- Создаёт заголовок второго уровня. -->
    ...
    <form action="php/create_connection.php" method="post">
        ...
        <div id="commissioner-id-container" style="display: none;">
            ...
            <input type="text" name="commissioner_id" id="commissioner_id" placeholder="Введите ID"><br><br>
        </div>
